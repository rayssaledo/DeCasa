...
public class ProfessionalProfileSilverPlanActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 105) {
                if (listFavorite.size() == 1 && listFavorite.get(0) == 1){
                    Toast.makeText(ProfessionalProfileSilverPlanActivity.this, getApplication().getString(
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        evaluationController = new EvaluationController(ProfessionalProfileSilverPlanActivity.this);
        userController = new UserController(ProfessionalProfileSilverPlanActivity.this);
        ...
        btn_evaluations.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfessionalProfileSilverPlanActivity.this,
